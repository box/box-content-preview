...
function getImageSmoothingEnabled(transform, interpolate) {
  ...
  /* Commented out for preview because this was causing images not to be rendered correctly when the itnterpolate
    value is set to false in the pdf. This was done based on this PR 
   (https://github.com/mozilla/pdf.js/pull/13991/files#) for pdf.js */

 /*if (interpolate !== undefined) {
     // If the value is explicitly set use it.
     return interpolate;
  } else */
   if (scale[0] <= actualScale || scale[1] <= actualScale) {
    return true;
  }
