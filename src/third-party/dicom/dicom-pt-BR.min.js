...
Ch={uf:["a.C.","d.C."],tf:["antes de Cristo","depois de Cristo"],wf:"JFMAMJJASOND".split(""),Cf:"JFMAMJJASOND".split(""),vf:"janeiro fevereiro mar\u00e7o abril maio junho julho agosto setembro outubro novembro dezembro".split(" "),Bf:"janeiro fevereiro mar\u00e7o abril maio junho julho agosto setembro outubro novembro dezembro".split(" "),yf:"jan fev mar abr mai jun jul ago set out nov dez".split(" "),Ef:"jan fev mar abr mai jun jul ago set out nov dez".split(" "),If:"domingo segunda-feira ter\u00e7a-feira quarta-feira quinta-feira sexta-feira s\u00e1bado".split(" "),Gf:"domingo segunda-feira ter\u00e7a-feira quarta-feira quinta-feira sexta-feira s\u00e1bado".split(" "),
Af:"dom seg ter qua qui sex s\u00e1b".split(" "),Ff:"dom seg ter qua qui sex s\u00e1b".split(" "),a:"DSTQQSS".split(""),Df:"DSTQQSS".split(""),zf:["T1","T2","T3","T4"],xf:["1\u00ba trimestre","2\u00ba trimestre","3\u00ba trimestre","4\u00ba trimestre"],qf:["AM","PM"],Vd:["EEEE, d 'de' MMMM 'de' y","d 'de' MMMM 'de' y","d 'de' MMM 'de' y","dd/MM/yy"],Zd:["HH:mm:ss zzzz","HH:mm:ss z","HH:mm:ss","HH:mm"],rf:["{1} {0}","{1} {0}","{1} {0}","{1} {0}"],Wd:6,b:[5,6],Xd:5};var Dh=/^(\d{4})(?:(?:-?(\d{2})(?:-?(\d{2}))?)|(?:-?(\d{3}))|(?:-?W(\d{2})(?:-?([1-7]))?))?$/,Eh=/^(\d{2})(?::?(\d{2})(?::?(\d{2})(\.\d+)?)?)?$/,Fh=/Z|(?:([-+])(\d{2})(?::?(\d{2}))?)$/;function Gh(a,b,c,d,e,f){u(a)?(this.j=a==Hh?b:0,this.g=a==Ih?b:0,this.a=a==Jh?b:0,this.b=a==Kh?b:0,this.c=a==Lh?b:0,this.h=a==Mh?b:0):(this.j=a||0,this.g=b||0,this.a=c||0,this.b=d||0,this.c=e||0,this.h=f||0)}Gh.prototype.clone=function(){return new Gh(this.j,this.g,this.a,this.b,this.c,this.h)};
...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("Cor");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Tamanho da fonte"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Excluir");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
function go(a){var b=L(a,0,0),c=L(a,1,0),d=L(a,2,0);a=Math.sqrt(b*b+c*c+d*d);if(1E-4>a)return"";b/=a;c/=a;d/=a;a=0>b?"R":"L";for(var e=0>c?"A":"P",f=0>d?"F":"H",b=Math.abs(b),c=Math.abs(c),d=Math.abs(d),h="",k=0;3>k;k++)if(.25<b&&b>c&&b>d)h+=a,b=0;else if(.25<c&&c>b&&c>d)h+=e,c=0;else if(.25<d&&d>b&&d>c)h+=f,d=0;else break;return h};function io(a){Jm.call(this,a.a);this.b=a;a=[["arrow","Seta","Desenha uma seta na imagem","Q"],["line","Dist\u00e2ncia","Mede a dist\u00e2ncia entre dois pontos","D"],["ellipse","Elipse","Mede a \u00e1rea e o valor m\u00e9dio de uma regi\u00e3o circular","E"],["angle","\u00c2ngulo","Mede o \u00e2ngulo entre duas linhas","A"],["cobbAngle","\u00c2ngulo de Cobb","Mede o \u00e2ngulo Cobb entre duas linhas","C"],["text","Texto","Adiciona uma anota\u00e7\u00e3o de texto \u00e0 imagem","T"],["spine","Coluna",
"Insere um r\u00f3tulo para a coluna",null],["gonstead","Gonstead","Adiciona marca\u00e7\u00f5es de Gonstead",null]];for(var b=0;b<a.length;b++){var c=a[b],c=jo(this,c[1],c[0],c[3]);this.I(c,!0)}a=new V("Salvar anota\u00e7\u00f5es");H(a,"action",this.c,!1,this);this.I(new cm,!0);this.I(a,!0)}v(io,Jm);function jo(a,b,c,d){var e=a.b.b;a=dn(b,d,null,a.b.a);H(a,"action",function(){gj(e.c,c)});return a}io.prototype.c=function(){var a=this.b.b,b=ko(a);b&&lo(a,b)};function mo(a){Km.call(this,a.a);this.b=a;no(this)}v(mo,Km);
function no(a){var b=a.b.b,c=dn("Pilha","S");H(c,"action",function(){gj(b.c,"stack")});a.I(c,!0);c=dn("Janela","W");H(c,"action",function(){gj(b.c,"windowLevel")});a.I(c,!0);c=dn("Panorama","P");H(c,"action",function(){gj(b.c,"pan")});a.I(c,!0);c=dn("Zoom","Z");H(c,"action",function(){gj(b.c,"zoom")});a.I(c,!0);if(c=a.b.g){var d=new Tm("Anotar");Rm(d,new io(c));a.I(d,!0)}a.I(new cm,!0);c=new V("Imagem importante");H(c,"action",a.b.b.cd,!1,a.b.b);a.I(c,!0);c=new V("Imagem importante (todas as visualiza\u00e7\u00f5es)");
H(c,"action",a.b.b.Kf,!1,a.b.b);a.I(c,!0);a.I(new cm,!0);c=new V("Tamanho real (1:1)");H(c,"action",a.b.oi,!1,a.b);d=new V("Dimensionar para caber");H(d,"action",a.b.pi,!1,a.b);var e=new V("Sobreposi\u00e7\u00f5es");H(e,"action",a.b.b.nc,!1,a.b.b);var f=new V("Substitui\u00e7\u00e3o do localizador");H(f,"action",a.b.b.Lf,!1,a.b.b);var h=new V("Remover \u00faltima anota\u00e7\u00e3o");H(h,"action",a.b.b.ce,!1,a.b.b);var k=new V("Remover todas as anota\u00e7\u00f5es");H(k,"action",a.b.b.di,!1,a.b.b);
var l=new V("Imprimir no console");H(l,"action",a.b.ci,!1,a.b);a.I(c,!0);a.I(d,!0);a.I(new cm,!0);a.I(e,!0);a.I(f,!0);a.I(new cm,!0);a.I(h,!0);a.I(k,!0);a.I(new cm,!0);a.I(l,!0);a.b.g?R(a,a.b.g.m()):R(a,void 0)};function oo(a,b){S.call(this,b?b.a:null);this.b=a;this.g=b}v(oo,S);oo.prototype.M=function(){this.g=this.b=null;oo.A.M.call(this)};function po(a,b,c,d){oo.call(this,a,b);this.lc=c;this.C=d;this.w=null;this.B=0;this.Vc=this.j=this.oa=this.Ea=null;this.ne=!0;this.R=0;this.h=null;this.N=[!1,!1,!1];this.Xc=!1;this.fb=this.Oe=this.F=this.c=null;this.ea=new ie(100);this.Wc=!1;this.pe=this.re=this.Re=this.Se=this.te=0}v(po,oo);function fn(a){return a.w?a.w.a:null}function Y(a,b){if(!a.w)return null;var c=a.w.Z;if(c&&0!==c.length)var d=q(b)?b:fo(a),c=c[a.Ea&&0!=a.Ea.length?a.Ea[q(d)?d:fo(a)]:0];else c=null;return c}
...
"Grade","Abra o menu de grade");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Retornar \u00e0 pasta");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("Modo de exibi\u00e7\u00e3o");gt(this,c,"Autom\u00e1tico","");gt(this,c,"Bin\u00e1rio","binary");gt(this,c,"Simples","simple");gt(this,c,"WebGL","webgl");b=new V("MultiMon");H(b,"action",
e.bi,!1,e);d=new V("Tela cheia");H(d,"action",f.mb,!1,f);var h=new V("Gerenciador do protocolo de suspens\u00e3o");H(h,"action",f.hi,!1,f);var k=new V("Configura\u00e7\u00f5es...");H(k,"action",f.ki,!1,f);f=new V("Ajuda");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","Mais");c=new $s(c,e,void 0,this.a);this.I(c,!0);break;
case 50:c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info","Sobreposi\u00e7\u00f5es","Alterna as sobreposi\u00e7\u00f5es");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Panorama","Aplica visualiza\u00e7\u00e3o panor\u00e2mica \u00e0 imagem");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Pilha","Procura pela pilha de imagens");break;case 100:ht(this,"magicX","3D","O cursor 3D correlaciona o mesmo ponto em diferentes imagens");break;case 110:ht(this,"windowLevel",
"Janela","Ajusta a janela/o n\u00edvel de contraste");break;case 130:ht(this,"zoom","Zoom","Aplica zoom \u00e0 imagem")}b=this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=new Rn("Compartilhar"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};
...
"click",this.ii,!1,this);this.F=new V("Exibir visualiza\u00e7\u00e3o padr\u00e3o");H(this.F,"action",this.Pc,!1,this);this.V=new V("Relat\u00f3rio de grava\u00e7\u00e3o");H(this.V,"action",this.df,!1,this);this.aa=new V("Exibir estudos por objetos");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};g.ig=function(a){a.b();a.h();this.Pc()};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("O arquivo n\u00e3o cont\u00e9m um estudo DICOM."))})}
