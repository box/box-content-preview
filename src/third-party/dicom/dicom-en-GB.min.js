...
Af:"Sun Mon Tue Wed Thu Fri Sat".split(" "),Ff:"Sun Mon Tue Wed Thu Fri Sat".split(" "),a:"SMTWTFS".split(""),Df:"SMTWTFS".split(""),zf:["Q1","Q2","Q3","Q4"],xf:["1st quarter","2nd quarter","3rd quarter","4th quarter"],qf:["am","pm"],Vd:["EEEE, d MMMM y","d MMMM y","d MMM y","dd/MM/y"],Zd:["HH:mm:ss zzzz","HH:mm:ss z","HH:mm:ss","HH:mm"],rf:["{1} 'at' {0}","{1} 'at' {0}","{1}, {0}","{1}, {0}"],Wd:0,b:[5,6],Xd:3};var Dh=/^(\d{4})(?:(?:-?(\d{2})(?:-?(\d{2}))?)|(?:-?(\d{3}))|(?:-?W(\d{2})(?:-?([1-7]))?))?$/,Eh=/^(\d{2})(?::?(\d{2})(?::?(\d{2})(\.\d+)?)?)?$/,Fh=/Z|(?:([-+])(\d{2})(?::?(\d{2}))?)$/;function Gh(a,b,c,d,e,f){u(a)?(this.j=a==Hh?b:0,this.g=a==Ih?b:0,this.a=a==Jh?b:0,this.b=a==Kh?b:0,this.c=a==Lh?b:0,this.h=a==Mh?b:0):(this.j=a||0,this.g=b||0,this.a=c||0,this.b=d||0,this.c=e||0,this.h=f||0)}Gh.prototype.clone=function(){return new Gh(this.j,this.g,this.a,this.b,this.c,this.h)};
