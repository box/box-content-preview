...
Ch={uf:["av. J.-C.","ap. J.-C."],tf:["avant J\u00e9sus-Christ","apr\u00e8s J\u00e9sus-Christ"],wf:"JFMAMJJASOND".split(""),Cf:"JFMAMJJASOND".split(""),vf:"janvier f\u00e9vrier mars avril mai juin juillet ao\u00fbt septembre octobre novembre d\u00e9cembre".split(" "),Bf:"janvier f\u00e9vrier mars avril mai juin juillet ao\u00fbt septembre octobre novembre d\u00e9cembre".split(" "),yf:"janv. f\u00e9vr. mars avr. mai juin juil. ao\u00fbt sept. oct. nov. d\u00e9c.".split(" "),Ef:"janv. f\u00e9vr. mars avr. mai juin juil. ao\u00fbt sept. oct. nov. d\u00e9c.".split(" "),If:"dimanche lundi mardi mercredi jeudi vendredi samedi".split(" "),
Gf:"dimanche lundi mardi mercredi jeudi vendredi samedi".split(" "),Af:"dim. lun. mar. mer. jeu. ven. sam.".split(" "),Ff:"dim. lun. mar. mer. jeu. ven. sam.".split(" "),a:"DLMMJVS".split(""),Df:"DLMMJVS".split(""),zf:["T1","T2","T3","T4"],xf:["1er trimestre","2e trimestre","3e trimestre","4e trimestre"],qf:["AM","PM"],Vd:["EEEE d MMMM y","d MMMM y","d MMM y","yy-MM-dd"],Zd:["HH:mm:ss zzzz","HH:mm:ss z","HH:mm:ss","HH:mm"],rf:["{1} '\u00e0' {0}","{1} '\u00e0' {0}","{1} {0}","{1} {0}"],Wd:6,b:[5,6],
Xd:5};var Dh=/^(\d{4})(?:(?:-?(\d{2})(?:-?(\d{2}))?)|(?:-?(\d{3}))|(?:-?W(\d{2})(?:-?([1-7]))?))?$/,Eh=/^(\d{2})(?::?(\d{2})(?::?(\d{2})(\.\d+)?)?)?$/,Fh=/Z|(?:([-+])(\d{2})(?::?(\d{2}))?)$/;function Gh(a,b,c,d,e,f){u(a)?(this.j=a==Hh?b:0,this.g=a==Ih?b:0,this.a=a==Jh?b:0,this.b=a==Kh?b:0,this.c=a==Lh?b:0,this.h=a==Mh?b:0):(this.j=a||0,this.g=b||0,this.a=c||0,this.b=d||0,this.c=e||0,this.h=f||0)}Gh.prototype.clone=function(){return new Gh(this.j,this.g,this.a,this.b,this.c,this.h)};
...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("Couleur");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Taille de police"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Supprimer");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
g.L=function(a){Yn(this);Jj(this.m(),1);Q(this.m(),a)};function Yn(a){a.c&&(a.c.hb(),a.c.W(),a.c=null)};var Zn="001021B0 00280011 00080080 00080060 00101010 00100030 00100020 00100040 00181030 00280010 0008103E 00080020 00081030".split(" "),$n={"00280011":"Colonnes","00080080":"Nom de l'\u00e9tablissement","00080060":"Modalit\u00e9","00101010":"\u00c2ge du patient","00100030":"Date de naissance du patient","001021B0":"Ant\u00e9c\u00e9dents","00100020":"ID patient","00100040":"Sexe du patient","00181030":"Nom de protocole","00280010":"Lignes","0008103E":"Description de la s\u00e9rie","00080020":"Date de l'examen",
"00081030":"Description de l'examen"};function ao(a){var b=a.a;this.a=a;this.b=fl(b,!0);this.Zc=this.b.getContext("2d");this.c=this.g=512;this.h=gl(this.Zc);this.j=!1}ao.prototype.L=function(a){Q(this.b,a)};ao.prototype.Ka=function(a,b){this.g=a;this.c=b;this.b.width=this.h*a;this.b.height=this.h*b;this.b.style.width=a+"px";this.b.style.height=b+"px"};
...
function go(a){var b=L(a,0,0),c=L(a,1,0),d=L(a,2,0);a=Math.sqrt(b*b+c*c+d*d);if(1E-4>a)return"";b/=a;c/=a;d/=a;a=0>b?"R":"L";for(var e=0>c?"A":"P",f=0>d?"F":"H",b=Math.abs(b),c=Math.abs(c),d=Math.abs(d),h="",k=0;3>k;k++)if(.25<b&&b>c&&b>d)h+=a,b=0;else if(.25<c&&c>b&&c>d)h+=e,c=0;else if(.25<d&&d>b&&d>c)h+=f,d=0;else break;return h};function io(a){Jm.call(this,a.a);this.b=a;a=[["arrow","Fl\u00e8che","Permet de dessiner une fl\u00e8che sur l'image","Q"],["line","Distance","Mesurez la distance entre deux points","D"],["ellipse","Ellipse","Mesurer la zone et la valeur moyenne d'une r\u00e9gion circulaire","E"],["angle","Angle","Mesurer l'angle entre deux lignes","A"],["cobbAngle","Angle de Cobb","Mesurez l'angle de Cobb entre deux lignes","C"],["text","Texte","Ajoutez une annotation \u00e0 l'image","T"],["spine","Colonne vert\u00e9brale",
"Ajoutez un libell\u00e9 \u00e0 la colonne vert\u00e9brale",null],["gonstead","Gonstead","Ajoutez des rep\u00e8res Gonstead",null]];for(var b=0;b<a.length;b++){var c=a[b],c=jo(this,c[1],c[0],c[3]);this.I(c,!0)}a=new V("Enregistrer les annotations");H(a,"action",this.c,!1,this);this.I(new cm,!0);this.I(a,!0)}v(io,Jm);function jo(a,b,c,d){var e=a.b.b;a=dn(b,d,null,a.b.a);H(a,"action",function(){gj(e.c,c)});return a}io.prototype.c=function(){var a=this.b.b,b=ko(a);b&&lo(a,b)};function mo(a){Km.call(this,a.a);this.b=a;no(this)}v(mo,Km);
function no(a){var b=a.b.b,c=dn("Pile","S");H(c,"action",function(){gj(b.c,"stack")});a.I(c,!0);c=dn("Fen\u00eatre","W");H(c,"action",function(){gj(b.c,"windowLevel")});a.I(c,!0);c=dn("Panoramique","P");H(c,"action",function(){gj(b.c,"pan")});a.I(c,!0);c=dn("Zoom","Z");H(c,"action",function(){gj(b.c,"zoom")});a.I(c,!0);if(c=a.b.g){var d=new Tm("Annoter");Rm(d,new io(c));a.I(d,!0)}a.I(new cm,!0);c=new V("Image cl\u00e9");H(c,"action",a.b.b.cd,!1,a.b.b);a.I(c,!0);c=new V("Image cl\u00e9 (toutes les vues)");
H(c,"action",a.b.b.Kf,!1,a.b.b);a.I(c,!0);a.I(new cm,!0);c=new V("Taille r\u00e9elle (1:1)");H(c,"action",a.b.oi,!1,a.b);d=new V("Mettre \u00e0 l'\u00e9chelle");H(d,"action",a.b.pi,!1,a.b);var e=new V("Superpositions");H(e,"action",a.b.b.nc,!1,a.b.b);var f=new V("Ignorer le localisateur");H(f,"action",a.b.b.Lf,!1,a.b.b);var h=new V("Supprimer la derni\u00e8re annotation");H(h,"action",a.b.b.ce,!1,a.b.b);var k=new V("Supprimer toutes les annotations");H(k,"action",a.b.b.di,!1,a.b.b);var l=new V("Imprimer vers la console");
...
g.S=function(a){dt.A.S.call(this,a);Ok(a,"goog-toolbar");Mk(a,"box-dicom-viewer-toolbar");this.c||(this.c=ho()?[30,70,90,110,10]:[30,70,90,110,130,60,100,10,70,20,50,40]);for(a=0;a<this.c.length;a++)switch(this.c[a]){case 10:var b=this.g,c=new io(b);R(c,b.m());b=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-annotate","Annoter");c=new $s(b,c,void 0,this.a);c.Ya("Opens the annotations menu");this.I(c,!0);break;case 20:R(this.j,this.g.m());c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-grid",
"Grille","Ouvre le menu de la grille");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Retour au dossier");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("Mode Affichage");gt(this,c,"Auto","");gt(this,c,"Binaire","binary");gt(this,c,"Simple","simple");gt(this,c,"WebGL","webgl");b=new V("MultiMon");H(b,"action",e.bi,!1,e);d=new V("Plein \u00e9cran");
H(d,"action",f.mb,!1,f);var h=new V("Gestionnaire de protocole de pr\u00e9sentation");H(h,"action",f.hi,!1,f);var k=new V("Param\u00e8tres...");H(k,"action",f.ki,!1,f);f=new V("Aide");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","Plus");c=new $s(c,e,void 0,this.a);this.I(c,!0);break;case 50:c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info",
"Superpositions","Affichez / masquez les superpositions");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Panoramique","Affichez l'image en panoramique");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Pile","Parcourez la pile d'images");break;case 100:ht(this,"magicX","3D","Le curseur 3D met en corr\u00e9lation un m\u00eame point sur diff\u00e9rentes images");break;case 110:ht(this,"windowLevel","Fen\u00eatre","R\u00e9glez la luminosit\u00e9 et le contraste de la fen\u00eatre");
break;case 130:ht(this,"zoom","Zoom","Agrandissez l'image")}b=this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=new Rn("Partager"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};
...
"click",this.ii,!1,this);this.F=new V("Afficher la vue par d\u00e9faut");H(this.F,"action",this.Pc,!1,this);this.V=new V("\u00c9crire un rapport");H(this.V,"action",this.df,!1,this);this.aa=new V("Afficher l'examen en triant par objets");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};g.ig=function(a){a.b();a.h();this.Pc()};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("Le fichier ne contient aucun examen DICOM."))})}
