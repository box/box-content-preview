...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("Renk");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Yaz\u0131 Tipi Boyutu"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Sil");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
g.L=function(a){Yn(this);Jj(this.m(),1);Q(this.m(),a)};function Yn(a){a.c&&(a.c.hb(),a.c.W(),a.c=null)};var Zn="001021B0 00280011 00080080 00080060 00101010 00100030 00100020 00100040 00181030 00280010 0008103E 00080020 00081030".split(" "),$n={"00280011":"S\u00fctunlar","00080080":"Kurum Ad\u0131","00080060":"Modalite","00101010":"Hastan\u0131n Ya\u015f\u0131","00100030":"Hastan\u0131n Do\u011fum Tarihi","001021B0":"Ge\u00e7mi\u015f","00100020":"Hasta Kimli\u011fi","00100040":"Hastan\u0131n Cinsiyeti","00181030":"Protokol Ad\u0131","00280010":"Sat\u0131rlar","0008103E":"Seri A\u00e7\u0131klamas\u0131",
"00080020":"\u00c7al\u0131\u015fma Tarihi","00081030":"\u00c7al\u0131\u015fma A\u00e7\u0131klamas\u0131"};function ao(a){var b=a.a;this.a=a;this.b=fl(b,!0);this.Zc=this.b.getContext("2d");this.c=this.g=512;this.h=gl(this.Zc);this.j=!1}ao.prototype.L=function(a){Q(this.b,a)};ao.prototype.Ka=function(a,b){this.g=a;this.c=b;this.b.width=this.h*a;this.b.height=this.h*b;this.b.style.width=a+"px";this.b.style.height=b+"px"};
...
b,d);c.textBaseline="top";c.textAlign="right";b=a.g-5;d=5;(f=a.a.h)&&(d+=N(c,"W "+Math.round(f.g)+" / C "+Math.round(f.b),b,d));d+=N(c,"\u00c7er\u00e7eve:"+(fo(a.a)+1).toString()+" / "+a.a.B.toString(),b,d);d+=N(c,a.a.C.hd(),b,d);if(f=a.a.g)(h=f.ia)&&(h=h.hands)&&0<h.length&&(d+=N(c,h[0].grabStrength.toFixed(4),b,d)),(f=f.F)&&N(c,f[0].toFixed(1)+", "+f[1].toFixed(1)+", "+f[2].toFixed(1),b,d)}b=a.g;d=a.c;f=Math.max(5,.04*b);h=Math.max(5,.04*d);m=ik(a.a,0,0);e=ik(a.a,b,0);k=ik(a.a,0,d);m&&e&&k&&(c.fillStyle=
Qb(a.a.b.b,"orientationColor","#888"),c.font='normal 13px Lato, "Helvetica Neue", Helvetica, Arial, sans-serif',c.textBaseline="top",c.textAlign="center",N(c,go(jg(m,k)),b/2,h),c.textBaseline="top",c.textAlign="left",N(c,go(jg(m,e)),f,d/2),c.textBaseline="top",c.textAlign="right",N(c,go(jg(e,m)),b-f,d/2),c.textBaseline="bottom",c.textAlign="center",N(c,go(jg(k,m)),b/2,d-h));if(!(0>=a.a.B)){d=a.g-6;h=2;b=a.c-4-2;m=d/a.a.B;f=Math.max(1,Math.ceil(m));c.lineWidth=1;c.fillStyle="#000";c.fillRect(3,b,d,
4);for(e=0;e<a.a.B;e++)(h=Y(a.a,e))&&Kg(h)&&(h=3+Math.floor(e*m),c.fillStyle="#3b3b3b",c.fillRect(h,b,f,4));h=3+Math.floor(fo(a.a)*m);m=Math.max(3,h-1);d=Math.min(3+d,h+f+1);c.fillStyle="#22a7f0";d=d-m;c.beginPath();c.moveTo(m+3,b);c.lineTo(m+d-3,b);c.quadraticCurveTo(m+d,b,m+d,b+3);c.lineTo(m+d,b+4-3);c.quadraticCurveTo(m+d,b+4,m+d-3,b+4);c.lineTo(m+3,b+4);c.quadraticCurveTo(m,b+4,m,b+4-3);c.lineTo(m,b+3);c.quadraticCurveTo(m,b,m+3,b);c.closePath();c.fill()}(h=Y(a.a))&&!Kg(h)&&(b=h.l,null===b?b=
null:(d=Fg(h))?(f=Eg(h,"00280008")||1,h="US"===Cg(h,"00080060")?3:2,b=b/(d.a*d.c*f*h)):b=null,null!==b&&(c.fillStyle="#fff",c.font="normal 100px sans-serif",c.textBaseline="middle",c.textAlign="center",c.fillText(Math.min(Math.round(100*b),99)+"%",a.g/2,a.c/2)));!ho()&&a.a.Ua()&&(c.strokeStyle="#22A7F0",c.lineWidth=3,c.strokeRect(0,0,a.g,a.c))}
...
function go(a){var b=L(a,0,0),c=L(a,1,0),d=L(a,2,0);a=Math.sqrt(b*b+c*c+d*d);if(1E-4>a)return"";b/=a;c/=a;d/=a;a=0>b?"R":"L";for(var e=0>c?"A":"P",f=0>d?"F":"H",b=Math.abs(b),c=Math.abs(c),d=Math.abs(d),h="",k=0;3>k;k++)if(.25<b&&b>c&&b>d)h+=a,b=0;else if(.25<c&&c>b&&c>d)h+=e,c=0;else if(.25<d&&d>b&&d>c)h+=f,d=0;else break;return h};function io(a){Jm.call(this,a.a);this.b=a;a=[["arrow","Ok","G\u00f6r\u00fcnt\u00fc \u00fczerinde bir ok \u00e7izer","Q"],["line","Mesafe","\u0130ki nokta aras\u0131ndaki mesafeyi \u00f6l\u00e7\u00fcn","D"],["ellipse","Elips","Bir dairesel b\u00f6lgenin alan\u0131n\u0131 ve ortalama de\u011ferini \u00f6l\u00e7\u00fcn","E"],["angle","A\u00e7\u0131","\u0130ki \u00e7izgi aras\u0131ndaki a\u00e7\u0131y\u0131 \u00f6l\u00e7\u00fcn","A"],["cobbAngle","Cobb A\u00e7\u0131s\u0131","\u0130ki \u00e7izgi aras\u0131ndaki Cobb a\u00e7\u0131s\u0131n\u0131 \u00f6l\u00e7\u00fcn",
"C"],["text","Metin","G\u00f6r\u00fcnt\u00fcye bir metin a\u00e7\u0131klamas\u0131 ekleyin","T"],["spine","Omurga","Omurgay\u0131 etiketleyin",null],["gonstead","Gonstead","Gonstead i\u015faretleri ekleyin",null]];for(var b=0;b<a.length;b++){var c=a[b],c=jo(this,c[1],c[0],c[3]);this.I(c,!0)}a=new V("A\u00e7\u0131klamalar\u0131 kaydet");H(a,"action",this.c,!1,this);this.I(new cm,!0);this.I(a,!0)}v(io,Jm);
function jo(a,b,c,d){var e=a.b.b;a=dn(b,d,null,a.b.a);H(a,"action",function(){gj(e.c,c)});return a}io.prototype.c=function(){var a=this.b.b,b=ko(a);b&&lo(a,b)};function mo(a){Km.call(this,a.a);this.b=a;no(this)}v(mo,Km);
function no(a){var b=a.b.b,c=dn("Y\u0131\u011f\u0131n","S");H(c,"action",function(){gj(b.c,"stack")});a.I(c,!0);c=dn("Pencere","W");H(c,"action",function(){gj(b.c,"windowLevel")});a.I(c,!0);c=dn("Yatay kayd\u0131r","P");H(c,"action",function(){gj(b.c,"pan")});a.I(c,!0);c=dn("Yak\u0131nla\u015ft\u0131r","Z");H(c,"action",function(){gj(b.c,"zoom")});a.I(c,!0);if(c=a.b.g){var d=new Tm("A\u00e7\u0131klama ekle");Rm(d,new io(c));a.I(d,!0)}a.I(new cm,!0);c=new V("Anahtar G\u00f6r\u00fcnt\u00fc");H(c,"action",
a.b.b.cd,!1,a.b.b);a.I(c,!0);c=new V("Anahtar G\u00f6r\u00fcnt\u00fc (t\u00fcm g\u00f6r\u00fcn\u00fcmler)");H(c,"action",a.b.b.Kf,!1,a.b.b);a.I(c,!0);a.I(new cm,!0);c=new V("Ger\u00e7ek Boyut (1:1)");H(c,"action",a.b.oi,!1,a.b);d=new V("S\u0131\u011fd\u0131rmak \u0130\u00e7in \u00d6l\u00e7ekle");H(d,"action",a.b.pi,!1,a.b);var e=new V("Yer Payla\u015f\u0131mlar\u0131");H(e,"action",a.b.b.nc,!1,a.b.b);var f=new V("Yer Belirleyiciyi Ge\u00e7ersiz K\u0131lma");H(f,"action",a.b.b.Lf,!1,a.b.b);var h=new V("Son a\u00e7\u0131klamay\u0131 kald\u0131r");
H(h,"action",a.b.b.ce,!1,a.b.b);var k=new V("T\u00fcm a\u00e7\u0131klamalar\u0131 kald\u0131r");H(k,"action",a.b.b.di,!1,a.b.b);var l=new V("Konsola kopyala");H(l,"action",a.b.ci,!1,a.b);a.I(c,!0);a.I(d,!0);a.I(new cm,!0);a.I(e,!0);a.I(f,!0);a.I(new cm,!0);a.I(h,!0);a.I(k,!0);a.I(new cm,!0);a.I(l,!0);a.b.g?R(a,a.b.g.m()):R(a,void 0)};function oo(a,b){S.call(this,b?b.a:null);this.b=a;this.g=b}v(oo,S);oo.prototype.M=function(){this.g=this.b=null;oo.A.M.call(this)};function po(a,b,c,d){oo.call(this,a,b);this.lc=c;this.C=d;this.w=null;this.B=0;this.Vc=this.j=this.oa=this.Ea=null;this.ne=!0;this.R=0;this.h=null;this.N=[!1,!1,!1];this.Xc=!1;this.fb=this.Oe=this.F=this.c=null;this.ea=new ie(100);this.Wc=!1;this.pe=this.re=this.Re=this.Se=this.te=0}v(po,oo);function fn(a){return a.w?a.w.a:null}function Y(a,b){if(!a.w)return null;var c=a.w.Z;if(c&&0!==c.length)var d=q(b)?b:fo(a),c=c[a.Ea&&0!=a.Ea.length?a.Ea[q(d)?d:fo(a)]:0];else c=null;return c}
...
g.S=function(a){dt.A.S.call(this,a);Ok(a,"goog-toolbar");Mk(a,"box-dicom-viewer-toolbar");this.c||(this.c=ho()?[30,70,90,110,10]:[30,70,90,110,130,60,100,10,70,20,50,40]);for(a=0;a<this.c.length;a++)switch(this.c[a]){case 10:var b=this.g,c=new io(b);R(c,b.m());b=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-annotate","A\u00e7\u0131klama ekle");c=new $s(b,c,void 0,this.a);c.Ya("Opens the annotations menu");this.I(c,!0);break;case 20:R(this.j,this.g.m());c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-grid",
"K\u0131lavuz","K\u0131lavuz men\u00fcs\u00fcn\u00fc a\u00e7\u0131n");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Klas\u00f6re d\u00f6n");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("G\u00f6r\u00fcnt\u00fcleme Modu");gt(this,c,"Otomatik","");gt(this,c,"Siyah Beyaz","binary");gt(this,c,"Basit","simple");gt(this,c,"WebGL","webgl");
b=new V("MultiMon");H(b,"action",e.bi,!1,e);d=new V("Tam Ekran");H(d,"action",f.mb,!1,f);var h=new V("Asma Protokol\u00fc Y\u00f6neticisi");H(h,"action",f.hi,!1,f);var k=new V("Ayarlar...");H(k,"action",f.ki,!1,f);f=new V("Yard\u0131m");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","Daha Fazla");c=new $s(c,e,void 0,this.a);
this.I(c,!0);break;case 50:c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info","Yer Payla\u015f\u0131mlar\u0131","Yer payla\u015f\u0131mlar\u0131 aras\u0131nda ge\u00e7i\u015f yapar");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Yatay kayd\u0131r","G\u00f6r\u00fcnt\u00fcy\u00fc yatay kayd\u0131r\u0131n");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Y\u0131\u011f\u0131n","G\u00f6r\u00fcnt\u00fc y\u0131\u011f\u0131n\u0131na g\u00f6z at\u0131n");break;case 100:ht(this,
"magicX","3B","3B \u0130mle\u00e7, ayn\u0131 noktay\u0131 farkl\u0131 g\u00f6r\u00fcnt\u00fclerde ili\u015fkilendirir");break;case 110:ht(this,"windowLevel","Pencere","Pencere/d\u00fczey kontrast\u0131n\u0131 ayarlay\u0131n");break;case 130:ht(this,"zoom","Yak\u0131nla\u015ft\u0131r","G\u00f6r\u00fcnt\u00fcy\u00fc yak\u0131nla\u015ft\u0131r\u0131n")}b=this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=
new Rn("Payla\u015f"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};function ht(a,b,c,d){c=it(a,"box-dicom-toolbar-icon box-dicom-toolbar-icon-"+b,c,d);var e=a.b;Jk(e.c,c,b);H(c,"action",function(){gj(e.c,b)})}g.Xg=function(a){if(a.target){var b=this.j,c=a.target;a=b.m();c&&(c=Ij(c.m()),wj(a,c.left,c.top+c.height));b.L("none"==a.style.display)}};g.lh=function(){this.b.nc()};
...
"click",this.ii,!1,this);this.F=new V("Varsay\u0131lan G\u00f6r\u00fcn\u00fcm\u00fc G\u00f6ster");H(this.F,"action",this.Pc,!1,this);this.V=new V("Rapor Yaz");H(this.V,"action",this.df,!1,this);this.aa=new V("\u00c7al\u0131\u015fmay\u0131 nesnelere g\u00f6re g\u00f6ster");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};
g.ig=function(a){a.b();a.h();this.Pc()};g.ii=function(a){Nm(this.ia,new nm(a.clientX,a.clientY),4)};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("Dosyan\u0131n bir DICOM \u00e7al\u0131\u015fmas\u0131 yok."))})}
