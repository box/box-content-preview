...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("V\u00e4ri");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Fonttikoko"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Poista");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
g.L=function(a){Yn(this);Jj(this.m(),1);Q(this.m(),a)};function Yn(a){a.c&&(a.c.hb(),a.c.W(),a.c=null)};var Zn="001021B0 00280011 00080080 00080060 00101010 00100030 00100020 00100040 00181030 00280010 0008103E 00080020 00081030".split(" "),$n={"00280011":"Sarakkeet","00080080":"Tutkimuslaitoksen nimi","00080060":"Modaliteetti","00101010":"Potilaan ik\u00e4","00100030":"Potilaan syntym\u00e4aika","001021B0":"Historia","00100020":"Potilastunnus","00100040":"Potilaan sukupuoli","00181030":"Protokollan nimi","00280010":"Rivit","0008103E":"Sarjan kuvaus","00080020":"Tutkimusp\u00e4iv\u00e4","00081030":"Tutkimuksen kuvaus"};function ao(a){var b=a.a;this.a=a;this.b=fl(b,!0);this.Zc=this.b.getContext("2d");this.c=this.g=512;this.h=gl(this.Zc);this.j=!1}ao.prototype.L=function(a){Q(this.b,a)};ao.prototype.Ka=function(a,b){this.g=a;this.c=b;this.b.width=this.h*a;this.b.height=this.h*b;this.b.style.width=a+"px";this.b.style.height=b+"px"};
...
function go(a){var b=L(a,0,0),c=L(a,1,0),d=L(a,2,0);a=Math.sqrt(b*b+c*c+d*d);if(1E-4>a)return"";b/=a;c/=a;d/=a;a=0>b?"R":"L";for(var e=0>c?"A":"P",f=0>d?"F":"H",b=Math.abs(b),c=Math.abs(c),d=Math.abs(d),h="",k=0;3>k;k++)if(.25<b&&b>c&&b>d)h+=a,b=0;else if(.25<c&&c>b&&c>d)h+=e,c=0;else if(.25<d&&d>b&&d>c)h+=f,d=0;else break;return h};function io(a){Jm.call(this,a.a);this.b=a;a=[["arrow","Nuoli","Piirr\u00e4 kuvaan nuoli","Q"],["line","Et\u00e4isyys","Mittaa kahden pisteen v\u00e4linen et\u00e4isyys","D"],["ellipse","Ellipsi","Mittaa ympyr\u00e4n ala ja keskiarvo","E"],["angle","Kulma","Mittaa kahden viivan kulma","A"],["cobbAngle","Cobbin kulma","Mittaa kahden viivan Cobbin kulma","C"],["text","Teksti","Lis\u00e4\u00e4 kuvaan huomautusteksti","T"],["spine","Selk\u00e4ranka","Merkitse selk\u00e4rangan osat",null],["gonstead","Gonstead",
"Lis\u00e4\u00e4 Gonsteadin merkinn\u00e4t",null]];for(var b=0;b<a.length;b++){var c=a[b],c=jo(this,c[1],c[0],c[3]);this.I(c,!0)}a=new V("Tallenna huomautukset");H(a,"action",this.c,!1,this);this.I(new cm,!0);this.I(a,!0)}v(io,Jm);function jo(a,b,c,d){var e=a.b.b;a=dn(b,d,null,a.b.a);H(a,"action",function(){gj(e.c,c)});return a}io.prototype.c=function(){var a=this.b.b,b=ko(a);b&&lo(a,b)};function mo(a){Km.call(this,a.a);this.b=a;no(this)}v(mo,Km);
function no(a){var b=a.b.b,c=dn("Pino","S");H(c,"action",function(){gj(b.c,"stack")});a.I(c,!0);c=dn("Ikkuna","W");H(c,"action",function(){gj(b.c,"windowLevel")});a.I(c,!0);c=dn("Panoroi","P");H(c,"action",function(){gj(b.c,"pan")});a.I(c,!0);c=dn("Zoomaa","Z");H(c,"action",function(){gj(b.c,"zoom")});a.I(c,!0);if(c=a.b.g){var d=new Tm("Lis\u00e4\u00e4 huomautus");Rm(d,new io(c));a.I(d,!0)}a.I(new cm,!0);c=new V("Avainkuva");H(c,"action",a.b.b.cd,!1,a.b.b);a.I(c,!0);c=new V("Avainkuva (kaikki n\u00e4kym\u00e4t)");
H(c,"action",a.b.b.Kf,!1,a.b.b);a.I(c,!0);a.I(new cm,!0);c=new V("Todellinen koko (1:1)");H(c,"action",a.b.oi,!1,a.b);d=new V("Sovita");H(d,"action",a.b.pi,!1,a.b);var e=new V("Kerrokset");H(e,"action",a.b.b.nc,!1,a.b.b);var f=new V("Sijaintity\u00f6kalun ohitus");H(f,"action",a.b.b.Lf,!1,a.b.b);var h=new V("Poista viimeinen huomautus");H(h,"action",a.b.b.ce,!1,a.b.b);var k=new V("Poista kaikki huomautukset");H(k,"action",a.b.b.di,!1,a.b.b);var l=new V("Tulosta konsoliin");H(l,"action",a.b.ci,!1,
...
g.S=function(a){dt.A.S.call(this,a);Ok(a,"goog-toolbar");Mk(a,"box-dicom-viewer-toolbar");this.c||(this.c=ho()?[30,70,90,110,10]:[30,70,90,110,130,60,100,10,70,20,50,40]);for(a=0;a<this.c.length;a++)switch(this.c[a]){case 10:var b=this.g,c=new io(b);R(c,b.m());b=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-annotate","Lis\u00e4\u00e4 huomautus");c=new $s(b,c,void 0,this.a);c.Ya("Opens the annotations menu");this.I(c,!0);break;case 20:R(this.j,this.g.m());c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-grid",
"Ruudukko","Avaa ruudukkovalikko");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Palaa kansioon");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("N\u00e4ytt\u00f6tila");gt(this,c,"Automaattinen","");gt(this,c,"Binaarinen","binary");gt(this,c,"Yksinkertainen","simple");gt(this,c,"WebGL","webgl");b=new V("Useita n\u00e4ytt\u00f6j\u00e4");
H(b,"action",e.bi,!1,e);d=new V("Koko n\u00e4ytt\u00f6");H(d,"action",f.mb,!1,f);var h=new V("Esitysk\u00e4yt\u00e4nt\u00f6jen hallinta");H(h,"action",f.hi,!1,f);var k=new V("Asetukset...");H(k,"action",f.ki,!1,f);f=new V("Ohje");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","Lis\u00e4\u00e4");c=new $s(c,e,void 0,this.a);
this.I(c,!0);break;case 50:c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info","Kerrokset","N\u00e4yt\u00e4 kerrokset");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Panoroi","Panoroi kuva");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Pino","Selaa kuvapinoa");break;case 100:ht(this,"magicX","3D","3D-kohdistin n\u00e4ytt\u00e4\u00e4 saman pisteen eri kuvissa");break;case 110:ht(this,"windowLevel","Ikkuna","S\u00e4\u00e4d\u00e4 ikkunan tai tason kontrastia");
break;case 130:ht(this,"zoom","Zoomaa","L\u00e4henn\u00e4 tai loitonna kuvaa")}b=this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=new Rn("Jaa"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};
...
"click",this.ii,!1,this);this.F=new V("N\u00e4yt\u00e4 oletusn\u00e4kym\u00e4");H(this.F,"action",this.Pc,!1,this);this.V=new V("Kirjoita raportti");H(this.V,"action",this.df,!1,this);this.aa=new V("N\u00e4yt\u00e4 tutkimus kohteittain");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};g.ig=function(a){a.b();a.h();this.Pc()};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("Tiedostossa ei ole DICOM-tutkimusta."))})}
