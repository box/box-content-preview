...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("Colore");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Dimensione carattere"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Elimina");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
cn.prototype.l=function(){var a=fn(this.b);if(a){var b=ai(a),a=prompt("Give a name for this window/level.  To remove a preset from the menu, simply select it while holding down the shift key."),c=this.b.h.clone();c.c=a;c.h=b;var b=this.b.b.b,d=Ob(b);d.add(c);ub(b.a,"windowLevelPresets",wa(d));W('Created "'+a+'"',this.a)}};function gn(a){Km.call(this,a.a);this.b=a;a=new V("Capovolge l'immagine orizzontalmente");H(a,"action",this.sg,!1,this);var b=new V("Capovolge l'immagine verticalmente");H(b,"action",this.tg,!1,this);var c=new V("Ruota l'immagine in senso orario");H(c,"action",this.ei,!1,this);var d=new V("Ruota l'immagine in senso antiorario");H(d,"action",this.fi,!1,this);var e=new V("Inverte l'immagine");H(e,"action",this.Hh,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);this.I(d,!0);this.I(new cm,
...
g.L=function(a){Yn(this);Jj(this.m(),1);Q(this.m(),a)};function Yn(a){a.c&&(a.c.hb(),a.c.W(),a.c=null)};var Zn="001021B0 00280011 00080080 00080060 00101010 00100030 00100020 00100040 00181030 00280010 0008103E 00080020 00081030".split(" "),$n={"00280011":"Colonne","00080080":"Nome dell'istituto","00080060":"Modalit\u00e0","00101010":"Et\u00e0 paziente","00100030":"Data di nascita paziente","001021B0":"Anamnesi","00100020":"ID paziente","00100040":"Sesso paziente","00181030":"Nome protocollo","00280010":"Righe","0008103E":"Descrizione serie","00080020":"Data studio","00081030":"Descrizione studio"};function ao(a){var b=a.a;this.a=a;this.b=fl(b,!0);this.Zc=this.b.getContext("2d");this.c=this.g=512;this.h=gl(this.Zc);this.j=!1}ao.prototype.L=function(a){Q(this.b,a)};ao.prototype.Ka=function(a,b){this.g=a;this.c=b;this.b.width=this.h*a;this.b.height=this.h*b;this.b.style.width=a+"px";this.b.style.height=b+"px"};
...
g.S=function(a){dt.A.S.call(this,a);Ok(a,"goog-toolbar");Mk(a,"box-dicom-viewer-toolbar");this.c||(this.c=ho()?[30,70,90,110,10]:[30,70,90,110,130,60,100,10,70,20,50,40]);for(a=0;a<this.c.length;a++)switch(this.c[a]){case 10:var b=this.g,c=new io(b);R(c,b.m());b=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-annotate","Annota");c=new $s(b,c,void 0,this.a);c.Ya("Opens the annotations menu");this.I(c,!0);break;case 20:R(this.j,this.g.m());c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-grid",
"Griglia","Apre il menu Griglia");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Torna alla cartella");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("Modalit\u00e0 di visualizzazione");gt(this,c,"Automatica","");gt(this,c,"Binaria","binary");gt(this,c,"Semplice","simple");gt(this,c,"WebGL","webgl");b=new V("Pi\u00f9 monitor");H(b,"action",
e.bi,!1,e);d=new V("Schermo intero");H(d,"action",f.mb,!1,f);var h=new V("Gestore protocolli di visualizzazione");H(h,"action",f.hi,!1,f);var k=new V("Impostazioni...");H(k,"action",f.ki,!1,f);f=new V("Guida");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","Altro");c=new $s(c,e,void 0,this.a);this.I(c,!0);break;case 50:c=
ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info","Overlay","Visualizza/nasconde gli overlay");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Panoramica","Esegue una panoramica dell'immagine");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Stack","Sfoglia lo stack di immagini");break;case 100:ht(this,"magicX","3D","Cursore 3D mostra lo stesso punto in due immagini diverse");break;case 110:ht(this,"windowLevel","Finestra","Regola il livello di contrasto della finestra");
break;case 130:ht(this,"zoom","Zoom","Esegue lo zoom dell'immagine")}b=this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=new Rn("Condividi"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};
...
"click",this.ii,!1,this);this.F=new V("Mostra vista predefinita");H(this.F,"action",this.Pc,!1,this);this.V=new V("Scrivi referto");H(this.V,"action",this.df,!1,this);this.aa=new V("Mostra studio per oggetti");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};g.ig=function(a){a.b();a.h();this.Pc()};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("Il file non contiene uno studio DICOM."))})}
