...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("Kolor");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Rozm. czcionki"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Usu\u0144");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
cn.prototype.l=function(){var a=fn(this.b);if(a){var b=ai(a),a=prompt("Give a name for this window/level.  To remove a preset from the menu, simply select it while holding down the shift key."),c=this.b.h.clone();c.c=a;c.h=b;var b=this.b.b.b,d=Ob(b);d.add(c);ub(b.a,"windowLevelPresets",wa(d));W('Created "'+a+'"',this.a)}};function gn(a){Km.call(this,a.a);this.b=a;a=new V("Przerzucenie obrazu w poziomie");H(a,"action",this.sg,!1,this);var b=new V("Przerzucenie obrazu w pionie");H(b,"action",this.tg,!1,this);var c=new V("Obr\u00f3t obrazu w prawo");H(c,"action",this.ei,!1,this);var d=new V("Obr\u00f3t obrazu w lewo");H(d,"action",this.fi,!1,this);var e=new V("Inwersja obrazu");H(e,"action",this.Hh,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);this.I(d,!0);this.I(new cm,!0);this.I(e,!0)}v(gn,Km);
...
function go(a){var b=L(a,0,0),c=L(a,1,0),d=L(a,2,0);a=Math.sqrt(b*b+c*c+d*d);if(1E-4>a)return"";b/=a;c/=a;d/=a;a=0>b?"R":"L";for(var e=0>c?"A":"P",f=0>d?"F":"H",b=Math.abs(b),c=Math.abs(c),d=Math.abs(d),h="",k=0;3>k;k++)if(.25<b&&b>c&&b>d)h+=a,b=0;else if(.25<c&&c>b&&c>d)h+=e,c=0;else if(.25<d&&d>b&&d>c)h+=f,d=0;else break;return h};function io(a){Jm.call(this,a.a);this.b=a;a=[["arrow","Strza\u0142ka","Dodanie na obrazie strza\u0142ki","Q"],["line","Odleg\u0142o\u015b\u0107","Pomiar odleg\u0142o\u015bci mi\u0119dzy dwoma punktami","D"],["ellipse","Elipsa","Pomiar powierzchni i \u015bredniej warto\u015bci obszaru kulistego","E"],["angle","K\u0105t","Pomiar k\u0105ta mi\u0119dzy dwiema liniami","A"],["cobbAngle","K\u0105t Cobba","Pomiar k\u0105ta Cobba mi\u0119dzy dwiema liniami","C"],["text","Tekst","Dodanie na obrazie adnotacji w postaci tekstu",
"T"],["spine","Kr\u0119gos\u0142up","Dodanie oznacze\u0144 kr\u0119gos\u0142upa",null],["gonstead","Gonstead","Dodanie znacznik\u00f3w Gonsteada",null]];for(var b=0;b<a.length;b++){var c=a[b],c=jo(this,c[1],c[0],c[3]);this.I(c,!0)}a=new V("Zapisz adnotacje");H(a,"action",this.c,!1,this);this.I(new cm,!0);this.I(a,!0)}v(io,Jm);function jo(a,b,c,d){var e=a.b.b;a=dn(b,d,null,a.b.a);H(a,"action",function(){gj(e.c,c)});return a}io.prototype.c=function(){var a=this.b.b,b=ko(a);b&&lo(a,b)};function mo(a){Km.call(this,a.a);this.b=a;no(this)}v(mo,Km);
function no(a){var b=a.b.b,c=dn("Stos","S");H(c,"action",function(){gj(b.c,"stack")});a.I(c,!0);c=dn("Okno","W");H(c,"action",function(){gj(b.c,"windowLevel")});a.I(c,!0);c=dn("Przes.","P");H(c,"action",function(){gj(b.c,"pan")});a.I(c,!0);c=dn("Zoom","Z");H(c,"action",function(){gj(b.c,"zoom")});a.I(c,!0);if(c=a.b.g){var d=new Tm("Adnotacje");Rm(d,new io(c));a.I(d,!0)}a.I(new cm,!0);c=new V("Obraz kluczowy");H(c,"action",a.b.b.cd,!1,a.b.b);a.I(c,!0);c=new V("Obraz kluczowy (wszystkie widoki)");H(c,
"action",a.b.b.Kf,!1,a.b.b);a.I(c,!0);a.I(new cm,!0);c=new V("Rozm. rzeczyw. (1:1)");H(c,"action",a.b.oi,!1,a.b);d=new V("Skaluj, aby dopasowa\u0107");H(d,"action",a.b.pi,!1,a.b);var e=new V("Nak\u0142adki");H(e,"action",a.b.b.nc,!1,a.b.b);var f=new V("Zast\u0105p lokalizator");H(f,"action",a.b.b.Lf,!1,a.b.b);var h=new V("Usu\u0144 ost. adnotacj\u0119");H(h,"action",a.b.b.ce,!1,a.b.b);var k=new V("Usu\u0144 wsz. adnotacje");H(k,"action",a.b.b.di,!1,a.b.b);var l=new V("Kopiuj do konsoli");H(l,"action",
...
g.S=function(a){dt.A.S.call(this,a);Ok(a,"goog-toolbar");Mk(a,"box-dicom-viewer-toolbar");this.c||(this.c=ho()?[30,70,90,110,10]:[30,70,90,110,130,60,100,10,70,20,50,40]);for(a=0;a<this.c.length;a++)switch(this.c[a]){case 10:var b=this.g,c=new io(b);R(c,b.m());b=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-annotate","Adnotacje");c=new $s(b,c,void 0,this.a);c.Ya("Opens the annotations menu");this.I(c,!0);break;case 20:R(this.j,this.g.m());c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-grid",
"Siatka","Otwarcie menu siatki");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Powr\u00f3t do folderu");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("Tryb wy\u015bw.");gt(this,c,"Auto","");gt(this,c,"Binarny","binary");gt(this,c,"Prosty","simple");gt(this,c,"WebGL","webgl");b=new V("WieleMon");H(b,"action",e.bi,!1,e);d=new V("Pe\u0142ny ekran");
H(d,"action",f.mb,!1,f);var h=new V("Mened\u017cer protoko\u0142\u00f3w wy\u015bwietlania");H(h,"action",f.hi,!1,f);var k=new V("Ustawienia...");H(k,"action",f.ki,!1,f);f=new V("Pomoc");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","Wi\u0119cej");c=new $s(c,e,void 0,this.a);this.I(c,!0);break;case 50:c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info",
"Nak\u0142adki","Wy\u015bwietlenie/ukrycie nak\u0142adek");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Przes.","Przesuni\u0119cie obrazu");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Stos","Wyszukiwanie w obr\u0119bie stosu obraz\u00f3w");break;case 100:ht(this,"magicX","3D","Kursor 3D koreluje ten sam punkt na r\u00f3\u017cnych obrazach");break;case 110:ht(this,"windowLevel","Okno","Dostosowanie jasno\u015bci/warto\u015bci \u015brodkowej");break;case 130:ht(this,
"zoom","Zoom","Zmiana powi\u0119kszenia obrazu")}b=this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=new Rn("Udost\u0119pnij"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};
...
"click",this.ii,!1,this);this.F=new V("Poka\u017c widok domy\u015blny");H(this.F,"action",this.Pc,!1,this);this.V=new V("Utw\u00f3rz raport");H(this.V,"action",this.df,!1,this);this.aa=new V("Uporz\u0105dkuj badanie wg obiekt\u00f3w");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};g.ig=function(a){a.b();a.h();this.Pc()};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("Plik nie zawiera badania DICOM."))})}
