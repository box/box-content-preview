...
Ch={uf:["a. C.","d. C."],tf:["antes de Cristo","despu\u00e9s de Cristo"],wf:"EFMAMJJASOND".split(""),Cf:"EFMAMJJASOND".split(""),vf:"enero febrero marzo abril mayo junio julio agosto septiembre octubre noviembre diciembre".split(" "),Bf:"enero febrero marzo abril mayo junio julio agosto septiembre octubre noviembre diciembre".split(" "),yf:"ene. feb. mar. abr. may. jun. jul. ago. sept. oct. nov. dic.".split(" "),Ef:"ene. feb. mar. abr. may. jun. jul. ago. sept. oct. nov. dic.".split(" "),If:"domingo lunes martes mi\u00e9rcoles jueves viernes s\u00e1bado".split(" "),Gf:"domingo lunes martes mi\u00e9rcoles jueves viernes s\u00e1bado".split(" "),
Af:"dom. lun. mar. mi\u00e9. jue. vie. s\u00e1b.".split(" "),Ff:"dom. lun. mar. mi\u00e9. jue. vie. s\u00e1b.".split(" "),a:"DLMXJVS".split(""),Df:"DLMXJVS".split(""),zf:["T1","T2","T3","T4"],xf:["1.er trimestre","2.\u00ba trimestre","3.er trimestre","4.\u00ba trimestre"],qf:["a. m.","p. m."],Vd:["EEEE, d 'de' MMMM 'de' y","d 'de' MMMM 'de' y","d MMM y","d/M/yy"],Zd:["H:mm:ss (zzzz)","H:mm:ss z","H:mm:ss","H:mm"],rf:["{1}, {0}","{1}, {0}","{1} {0}","{1} {0}"],Wd:0,b:[5,6],Xd:3};var Dh=/^(\d{4})(?:(?:-?(\d{2})(?:-?(\d{2}))?)|(?:-?(\d{3}))|(?:-?W(\d{2})(?:-?([1-7]))?))?$/,Eh=/^(\d{2})(?::?(\d{2})(?::?(\d{2})(\.\d+)?)?)?$/,Fh=/Z|(?:([-+])(\d{2})(?::?(\d{2}))?)$/;function Gh(a,b,c,d,e,f){u(a)?(this.j=a==Hh?b:0,this.g=a==Ih?b:0,this.a=a==Jh?b:0,this.b=a==Kh?b:0,this.c=a==Lh?b:0,this.h=a==Mh?b:0):(this.j=a||0,this.g=b||0,this.a=c||0,this.b=d||0,this.c=e||0,this.h=f||0)}Gh.prototype.clone=function(){return new Gh(this.j,this.g,this.a,this.b,this.c,this.h)};
...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("Color");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Tama\u00f1o de fuente"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Eliminar");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
g.L=function(a){Yn(this);Jj(this.m(),1);Q(this.m(),a)};function Yn(a){a.c&&(a.c.hb(),a.c.W(),a.c=null)};var Zn="001021B0 00280011 00080080 00080060 00101010 00100030 00100020 00100040 00181030 00280010 0008103E 00080020 00081030".split(" "),$n={"00280011":"Columnas","00080080":"Nombre de la instituci\u00f3n","00080060":"Modalidad","00101010":"Edad del paciente","00100030":"Fecha de nacimiento del paciente","001021B0":"Historial","00100020":"ID del paciente","00100040":"Sexo del paciente","00181030":"Nombre del protocolo","00280010":"Filas","0008103E":"Descripci\u00f3n de la serie","00080020":"Fecha del estudio",
"00081030":"Descripci\u00f3n del estudio"};function ao(a){var b=a.a;this.a=a;this.b=fl(b,!0);this.Zc=this.b.getContext("2d");this.c=this.g=512;this.h=gl(this.Zc);this.j=!1}ao.prototype.L=function(a){Q(this.b,a)};ao.prototype.Ka=function(a,b){this.g=a;this.c=b;this.b.width=this.h*a;this.b.height=this.h*b;this.b.style.width=a+"px";this.b.style.height=b+"px"};
...
function go(a){var b=L(a,0,0),c=L(a,1,0),d=L(a,2,0);a=Math.sqrt(b*b+c*c+d*d);if(1E-4>a)return"";b/=a;c/=a;d/=a;a=0>b?"R":"L";for(var e=0>c?"A":"P",f=0>d?"F":"H",b=Math.abs(b),c=Math.abs(c),d=Math.abs(d),h="",k=0;3>k;k++)if(.25<b&&b>c&&b>d)h+=a,b=0;else if(.25<c&&c>b&&c>d)h+=e,c=0;else if(.25<d&&d>b&&d>c)h+=f,d=0;else break;return h};function io(a){Jm.call(this,a.a);this.b=a;a=[["arrow","Flecha","Permite dibujar una flecha en la imagen","Q"],["line","Distancia","Permite medir la distancia entre dos puntos","D"],["ellipse","Elipse","Permite medir el \u00e1rea y calcula el valor promedio de una regi\u00f3n circular","E"],["angle","\u00c1ngulo","Permite medir el \u00e1ngulo entre dos l\u00edneas","A"],["cobbAngle","\u00c1ngulo de Cobb","Permite medir el \u00e1ngulo de Cobb entre dos l\u00edneas","C"],["text","Texto","Permite agregar una anotaci\u00f3n de texto a la imagen",
"T"],["spine","Columna vertebral","Permite se\u00f1alar la columna vertebral",null],["gonstead","Gonstead","Permite agregar marcas de Gonstead",null]];for(var b=0;b<a.length;b++){var c=a[b],c=jo(this,c[1],c[0],c[3]);this.I(c,!0)}a=new V("Guardar anotaciones");H(a,"action",this.c,!1,this);this.I(new cm,!0);this.I(a,!0)}v(io,Jm);function jo(a,b,c,d){var e=a.b.b;a=dn(b,d,null,a.b.a);H(a,"action",function(){gj(e.c,c)});return a}io.prototype.c=function(){var a=this.b.b,b=ko(a);b&&lo(a,b)};function mo(a){Km.call(this,a.a);this.b=a;no(this)}v(mo,Km);
function no(a){var b=a.b.b,c=dn("Pila","S");H(c,"action",function(){gj(b.c,"stack")});a.I(c,!0);c=dn("Ventana","W");H(c,"action",function(){gj(b.c,"windowLevel")});a.I(c,!0);c=dn("Panor\u00e1mica","P");H(c,"action",function(){gj(b.c,"pan")});a.I(c,!0);c=dn("Zoom","Z");H(c,"action",function(){gj(b.c,"zoom")});a.I(c,!0);if(c=a.b.g){var d=new Tm("Anotar");Rm(d,new io(c));a.I(d,!0)}a.I(new cm,!0);c=new V("Imagen principal");H(c,"action",a.b.b.cd,!1,a.b.b);a.I(c,!0);c=new V("Imagen principal (todas las vistas)");
H(c,"action",a.b.b.Kf,!1,a.b.b);a.I(c,!0);a.I(new cm,!0);c=new V("Tama\u00f1o actual (1:1)");H(c,"action",a.b.oi,!1,a.b);d=new V("Ajustar a la ventana");H(d,"action",a.b.pi,!1,a.b);var e=new V("Superposiciones");H(e,"action",a.b.b.nc,!1,a.b.b);var f=new V("Anulaci\u00f3n del localizador");H(f,"action",a.b.b.Lf,!1,a.b.b);var h=new V("Borrar \u00faltima anotaci\u00f3n");H(h,"action",a.b.b.ce,!1,a.b.b);var k=new V("Borrar todas las anotaciones");H(k,"action",a.b.b.di,!1,a.b.b);var l=new V("Copiar en consola");
H(l,"action",a.b.ci,!1,a.b);a.I(c,!0);a.I(d,!0);a.I(new cm,!0);a.I(e,!0);a.I(f,!0);a.I(new cm,!0);a.I(h,!0);a.I(k,!0);a.I(new cm,!0);a.I(l,!0);a.b.g?R(a,a.b.g.m()):R(a,void 0)};function oo(a,b){S.call(this,b?b.a:null);this.b=a;this.g=b}v(oo,S);oo.prototype.M=function(){this.g=this.b=null;oo.A.M.call(this)};function po(a,b,c,d){oo.call(this,a,b);this.lc=c;this.C=d;this.w=null;this.B=0;this.Vc=this.j=this.oa=this.Ea=null;this.ne=!0;this.R=0;this.h=null;this.N=[!1,!1,!1];this.Xc=!1;this.fb=this.Oe=this.F=this.c=null;this.ea=new ie(100);this.Wc=!1;this.pe=this.re=this.Re=this.Se=this.te=0}v(po,oo);function fn(a){return a.w?a.w.a:null}function Y(a,b){if(!a.w)return null;var c=a.w.Z;if(c&&0!==c.length)var d=q(b)?b:fo(a),c=c[a.Ea&&0!=a.Ea.length?a.Ea[q(d)?d:fo(a)]:0];else c=null;return c}
...
g.S=function(a){dt.A.S.call(this,a);Ok(a,"goog-toolbar");Mk(a,"box-dicom-viewer-toolbar");this.c||(this.c=ho()?[30,70,90,110,10]:[30,70,90,110,130,60,100,10,70,20,50,40]);for(a=0;a<this.c.length;a++)switch(this.c[a]){case 10:var b=this.g,c=new io(b);R(c,b.m());b=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-annotate","Anotar");c=new $s(b,c,void 0,this.a);c.Ya("Opens the annotations menu");this.I(c,!0);break;case 20:R(this.j,this.g.m());c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-grid",
"Cuadr\u00edcula","Permite abrir el men\u00fa de cuadr\u00edcula");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Volver a carpeta");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("Modo de vista");gt(this,c,"Autom\u00e1tica","");gt(this,c,"Binaria","binary");gt(this,c,"Sencilla","simple");gt(this,c,"WebGL","webgl");b=new V("Multimonitor");
H(b,"action",e.bi,!1,e);d=new V("Pantalla completa");H(d,"action",f.mb,!1,f);var h=new V("Gestor de protocolos de clasificaci\u00f3n");H(h,"action",f.hi,!1,f);var k=new V("Configuraci\u00f3n...");H(k,"action",f.ki,!1,f);f=new V("Ayuda");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","M\u00e1s");c=new $s(c,e,void 0,this.a);
this.I(c,!0);break;case 50:c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info","Superposiciones","Permite activar/desactivar las superposiciones");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Panor\u00e1mica","Permite desplazar la imagen");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Pila","Permite explorar la pila de im\u00e1genes");break;case 100:ht(this,"magicX","3D","El cursor 3D correlaciona el mismo punto en distintas im\u00e1genes");break;case 110:ht(this,
"windowLevel","Ventana","Permite ajustar el contraste de nivel/ventana");break;case 130:ht(this,"zoom","Zoom","Permite controlar el zoom de la imagen")}b=this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=new Rn("Compartir"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};
...
"click",this.ii,!1,this);this.F=new V("Mostrar vista predeterminada");H(this.F,"action",this.Pc,!1,this);this.V=new V("Escribir informe");H(this.V,"action",this.df,!1,this);this.aa=new V("Mostrar estudio por objetos");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};g.ig=function(a){a.b();a.h();this.Pc()};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("El archivo no tiene un estudio DICOM."))})}
