...
function Vm(a){a.na?a.rc&&a.na.za()!=a&&Vk(a.na,a):Rm(a,new Jm(a.a),!0);a.na.m()||a.na.ba();return a.na}function Rm(a,b,c){var d=a.na;b!=d&&(d&&(a.ob(),a.Y&&Um(a,d,!1)),a.na=b,a.rc=!c,b&&(Vk(b,a),b.L(!1,!0),b.Yb=!1,Em(b,!1),a.Y&&Um(a,b,!0)))}g.gb=function(a){return Vm(this).gb(a)};Jl("goog-submenu",function(){return new Tm(null)});function $m(a){Km.call(this,a.a);this.g=a;this.b=null;a=new Tm("Farve");for(var b="Green #71c181 Blue #718da5 Yellow #f2d43b Purple #8a59b2 Red #cd3a56 Orange #de9b2a".split(" "),c=0;c<b.length;c+=2)an(this,a,b[c],b[c+1]);for(var b=new Tm("Skriftst\u00f8rrelse"),d=[8,9,10,11,12,14,16,18,20,24,28,32],c=0;c<d.length;c++)bn(this,b,d[c]);c=new V("Slet");H(c,"action",this.l,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);R(this,this.g.g.h.document.body)}v($m,Km);
...
cn.prototype.l=function(){var a=fn(this.b);if(a){var b=ai(a),a=prompt("Give a name for this window/level.  To remove a preset from the menu, simply select it while holding down the shift key."),c=this.b.h.clone();c.c=a;c.h=b;var b=this.b.b.b,d=Ob(b);d.add(c);ub(b.a,"windowLevelPresets",wa(d));W('Created "'+a+'"',this.a)}};function gn(a){Km.call(this,a.a);this.b=a;a=new V("Spejlvend billedet vandret");H(a,"action",this.sg,!1,this);var b=new V("Spejlvend billedet lodret");H(b,"action",this.tg,!1,this);var c=new V("Roter billedet med uret");H(c,"action",this.ei,!1,this);var d=new V("Roter billedet mod uret");H(d,"action",this.fi,!1,this);var e=new V("Inverter billedet");H(e,"action",this.Hh,!1,this);this.I(a,!0);this.I(b,!0);this.I(new cm,!0);this.I(c,!0);this.I(d,!0);this.I(new cm,!0);this.I(e,!0)}v(gn,Km);g=gn.prototype;
...
g.L=function(a){Yn(this);Jj(this.m(),1);Q(this.m(),a)};function Yn(a){a.c&&(a.c.hb(),a.c.W(),a.c=null)};var Zn="001021B0 00280011 00080080 00080060 00101010 00100030 00100020 00100040 00181030 00280010 0008103E 00080020 00081030".split(" "),$n={"00280011":"Kolonner","00080080":"Institutionens navn","00080060":"Modalitet","00101010":"Patientens alder","00100030":"Patientens f\u00f8dselsdato","001021B0":"Historik","00100020":"Patient-id","00100040":"Patientens k\u00f8n","00181030":"Protokolnavn","00280010":"R\u00e6kker","0008103E":"Seriebeskrivelse","00080020":"Unders\u00f8gelsesdato","00081030":"Unders\u00f8gelsesbeskrivelse"};function ao(a){var b=a.a;this.a=a;this.b=fl(b,!0);this.Zc=this.b.getContext("2d");this.c=this.g=512;this.h=gl(this.Zc);this.j=!1}ao.prototype.L=function(a){Q(this.b,a)};ao.prototype.Ka=function(a,b){this.g=a;this.c=b;this.b.width=this.h*a;this.b.height=this.h*b;this.b.style.width=a+"px";this.b.style.height=b+"px"};
...
function go(a){var b=L(a,0,0),c=L(a,1,0),d=L(a,2,0);a=Math.sqrt(b*b+c*c+d*d);if(1E-4>a)return"";b/=a;c/=a;d/=a;a=0>b?"R":"L";for(var e=0>c?"A":"P",f=0>d?"F":"H",b=Math.abs(b),c=Math.abs(c),d=Math.abs(d),h="",k=0;3>k;k++)if(.25<b&&b>c&&b>d)h+=a,b=0;else if(.25<c&&c>b&&c>d)h+=e,c=0;else if(.25<d&&d>b&&d>c)h+=f,d=0;else break;return h};function io(a){Jm.call(this,a.a);this.b=a;a=[["arrow","Pil","Tegner en pil p\u00e5 billedet","Q"],["line","Afstand","M\u00e5l afstanden mellem to punkter","D"],["ellipse","Ellipse","M\u00e5l omr\u00e5det og den gennemsnitlige v\u00e6rdi for en cirkul\u00e6r region","E"],["angle","Vinkel","M\u00e5l vinklen mellem to linjer","A"],["cobbAngle","Cobb-vinkel","M\u00e5l Cobb-vinklen mellem to linjer","C"],["text","Tekst","Tilf\u00f8j en tekstanm\u00e6rkning til billedet","T"],["spine","Rygs\u00f8jle","M\u00e6rk rygs\u00f8jlen",
null],["gonstead","Gonstead","Tilf\u00f8j Gonstead-markeringer",null]];for(var b=0;b<a.length;b++){var c=a[b],c=jo(this,c[1],c[0],c[3]);this.I(c,!0)}a=new V("Gem anm\u00e6rkninger");H(a,"action",this.c,!1,this);this.I(new cm,!0);this.I(a,!0)}v(io,Jm);function jo(a,b,c,d){var e=a.b.b;a=dn(b,d,null,a.b.a);H(a,"action",function(){gj(e.c,c)});return a}io.prototype.c=function(){var a=this.b.b,b=ko(a);b&&lo(a,b)};function mo(a){Km.call(this,a.a);this.b=a;no(this)}v(mo,Km);
function no(a){var b=a.b.b,c=dn("Stak","S");H(c,"action",function(){gj(b.c,"stack")});a.I(c,!0);c=dn("Vindue","W");H(c,"action",function(){gj(b.c,"windowLevel")});a.I(c,!0);c=dn("Panorer","P");H(c,"action",function(){gj(b.c,"pan")});a.I(c,!0);c=dn("Zoom","Z");H(c,"action",function(){gj(b.c,"zoom")});a.I(c,!0);if(c=a.b.g){var d=new Tm("Tilf\u00f8j anm\u00e6rkning");Rm(d,new io(c));a.I(d,!0)}a.I(new cm,!0);c=new V("Vigtigt billede");H(c,"action",a.b.b.cd,!1,a.b.b);a.I(c,!0);c=new V("Vigtigt billede (alle visninger)");
H(c,"action",a.b.b.Kf,!1,a.b.b);a.I(c,!0);a.I(new cm,!0);c=new V("Faktisk st\u00f8rrelse (1:1)");H(c,"action",a.b.oi,!1,a.b);d=new V("Tilpas st\u00f8rrelse");H(d,"action",a.b.pi,!1,a.b);var e=new V("Overlejringer");H(e,"action",a.b.b.nc,!1,a.b.b);var f=new V("Tilsides\u00e6t lokaliseringsprogram");H(f,"action",a.b.b.Lf,!1,a.b.b);var h=new V("Fjern seneste anm\u00e6rkning");H(h,"action",a.b.b.ce,!1,a.b.b);var k=new V("Fjern alle anm\u00e6rkninger");H(k,"action",a.b.b.di,!1,a.b.b);var l=new V("Kopi\u00e9r til konsol");
...
g.S=function(a){dt.A.S.call(this,a);Ok(a,"goog-toolbar");Mk(a,"box-dicom-viewer-toolbar");this.c||(this.c=ho()?[30,70,90,110,10]:[30,70,90,110,130,60,100,10,70,20,50,40]);for(a=0;a<this.c.length;a++)switch(this.c[a]){case 10:var b=this.g,c=new io(b);R(c,b.m());b=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-annotate","Tilf\u00f8j anm\u00e6rkning");c=new $s(b,c,void 0,this.a);c.Ya("Opens the annotations menu");this.I(c,!0);break;case 20:R(this.j,this.g.m());c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-grid",
"Gitter","\u00c5bn gittermenuen");H(c,"action",this.Xg,!1,this);break;case 30:var c=this.a,d=this.b,b=new V("Tilbage til mappe");H(b,"action",d.vg,!1,d);d=new Jm;d.I(b,!0);c=c.G("div","box-dicom-toolbar-logo");c=new $s(c,d,void 0,this.a);c.Ya("Box DICOM");this.I(c,!0);break;case 40:var e=this.b,f=this.g,c=new Tm("Visningstilstand");gt(this,c,"Automatisk","");gt(this,c,"Sort/hvid","binary");gt(this,c,"Simpel","simple");gt(this,c,"WebGL","webgl");b=new V("MultiMon");H(b,"action",e.bi,!1,e);d=new V("Fuld sk\u00e6rm");
H(d,"action",f.mb,!1,f);var h=new V("Oph\u00e6ngningsprotokolstyring");H(h,"action",f.hi,!1,f);var k=new V("Indstillinger...");H(k,"action",f.ki,!1,f);f=new V("Hj\u00e6lp");H(f,"action",e.Ih,!1,e);e=new Jm;e.I(c,!0);e.I(b,!0);e.I(d,!0);e.I(h,!0);e.I(new cm,!0);e.I(k,!0);e.I(new cm,!0);e.I(f,!0);R(e,this.g.m());c=Vm(c);R(c,this.g.m());c=et(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-more","Mere");c=new $s(c,e,void 0,this.a);this.I(c,!0);break;case 50:c=ft(this,"box-dicom-toolbar-icon box-dicom-toolbar-icon-info",
"Overlejringer","Sl\u00e5r overlejringer til og fra");H(c,"action",this.lh,!1,this);break;case 60:ht(this,"pan","Panorer","Panorer p\u00e5 billedet");break;case 70:this.I(new at,!0);break;case 90:ht(this,"stack","Stak","Gennemse en stak af billeder");break;case 100:ht(this,"magicX","3D","3D-mark\u00f8r korrelerer samme punkt p\u00e5 forskellige billeder");break;case 110:ht(this,"windowLevel","Vindue","Juster vindue/niveaukontrast");break;case 130:ht(this,"zoom","Zoom","Zoom ind p\u00e5 billedet")}b=
this.b;a=this.g;c=new vm;this.I(c,!0);d=c.m();Ok(d,"goog-container");Ok(d,"goog-container-vertical");Mk(d,"box-dicom-viewer-toolbar-right");ho()||(d=new Rn("Del"),H(d,"action",b.li,!1,b),c.I(d,!0));b=this.a.G("span");b.innerHTML="&#8677;";b=new Rn(b);H(b,"action",a.mg,!1,a);c.I(b,!0);this.L(this.h)};function ht(a,b,c,d){c=it(a,"box-dicom-toolbar-icon box-dicom-toolbar-icon-"+b,c,d);var e=a.b;Jk(e.c,c,b);H(c,"action",function(){gj(e.c,b)})}
g.Xg=function(a){if(a.target){var b=this.j,c=a.target;a=b.m();c&&(c=Ij(c.m()),wj(a,c.left,c.top+c.height));b.L("none"==a.style.display)}};g.lh=function(){this.b.nc()};function ft(a,b,c,d){b=et(a,b,c);b=new Vn(b);b.Ya(d);a.I(b,!0);return b}function it(a,b,c,d){b=et(a,b,c);b=new ct(b);b.Ya(d);b.Eb&=-17;a.I(b,!0);return b}function et(a,b,c){a=a.a;return a.G("div",{"class":"box-dicom-toolbar-button"},a.G("div",{"class":b}),a.G("div",{"class":"box-dicom-toolbar-caption"},c))}g.M=function(){dt.A.M.call(this)};
g.P=function(){dt.A.P.call(this)};g.fa=function(){dt.A.fa.call(this)};
...
"click",this.ii,!1,this);this.F=new V("Vis standardvisning");H(this.F,"action",this.Pc,!1,this);this.V=new V("Skriv rapport");H(this.V,"action",this.df,!1,this);this.aa=new V("Vis unders\u00f8gelse efter objekter");H(this.aa,"action",this.qh,!1,this);a=new Km;a.Tc=!0;a.I(this.F,!0);a.I(this.V,!0);a.I(this.aa,!0);R(a,this.g.m());Lm(a,this.l,5,4,!0);this.ia=a};g.P=function(){Gt.A.P.call(this)};g.hg=function(a){a.b();a.h()};g.ig=function(a){a.b();a.h();this.Pc()};
...
function Tt(a,b,c){var d=a.b.h;Ue(b,function(b){b=b.target;400===df(b)?or(ef(b)):(b=ff(b),"error"===b.error&&"session expired"===b.errormessage?St():"fatal"===b.status&&(null===Box.config.userId||2>=Box.config.userId)?St():"error"===b.status?or(b.message):b.study?(b=Th(d,b.study),c&&(b.g.fileId=c),Kt(a.l,b)):or("Filen har ikke en DICOM-unders\u00f8gelse."))})}
