      ...
      _createClass(RepresentationLoaderRM, [{
        ...
        value: function getFileIds(filePath, baseFileId) {
          ...
          return new _lie2['default'](function (resolve, reject) {
            ...
            _this.get(url).then(function (xhr) {
              if (xhr.status === 200) {

                var _data = JSON.parse(xhr.response);

                if (_data.item) {
                  _this.addToCache(filePath, _data.item.fileId, _data.item.fileVersionId);
         ...
         * @returns {string} Url to GET, for representation
        */
      }, {
        ...
        value: function buildRepresentationUrl(fileId, fileVersionId, repParams) {
          ...
          return this.apiBase + '/representation/file_version_' + fileVersionId + '/' + repParams;
        }
...
/***/ function(module, exports, __webpack_require__) {
    ...
    var BaseRepresentationLoader = (function () {
       ...
       * additional functionality depending on endpoints and data returned.
       * Acts as an outline for the basic contract a loader must follow.
       * @public
      ...
      _createClass(BaseRepresentationLoader, [{
        ...
        value: function load(fileId, fileVersionId, repType, progress, params) {
          ...
          return this.getRepresentation(url, progress, params);
        }
        ...
        */
         ...
         * @returns {string} Url to make a request to, for representation
        */
      }, {
        key: 'buildRepresentationUrl',
    ...
    var XHR = (function () {
      ...
      */
      ...
      _createClass(XHR, [{
        ...
        * @returns {Promise} A Promise that resolves in the xhr
        */
      }, {
        key: 'makeRequest',
      ...
      */
      ...
      _createClass(RepresentationLoaderV2, [{
        ...
        */
        ...
        /**
         * Build the appropriate url to load the representation from V2 Representations API
         * @param {string} fileId The Box File ID of the file we want to load a representation from
         * @param {string} fileVersionId The Box File Version ID of the file version we want to load
         * a representation for
         ...
         * use as query params
         * @returns {Promise} Resolves in a valid url to make a GET request with,
         * for the representation we want to get.
         */
      }, {
        key: 'buildRepresentationUrl',
        value: function buildRepresentationUrl(fileId, fileVersionId, repParams) {
          ...
          if (repParams.properties) {
            ...
            props += keys.reduce(function conatenateFileNames(previous, current) {
              /*eslint-disable*/ // Any line breaking of string template throws in a whitespace character
          ...
          if (!this.contentBaseCache[fileId]) {
            ...
            // From here, we're going to get a content base url for representations
            this.contentBaseCache[fileId] = this.xhr.get(this.apiBase + '/2.0/files/' + fileId + '?fields=representations', null, { responseType: 'json' }).then(function (resp) {
      ...
      _createClass(Metadata, [{
        ...
        */
        ...
        value: function get(id, scope, template) {
          ...
          return this.xhr.get(this.apiBase + '/2.0/files/' + id + '/metadata/' + scope + '/' + template, null, { responseType: 'json' });
        }
        ...
        */
        ...
        value: function getAll(id) {
          ...
          return this.xhr.get(this.apiBase + '/2.0/files/' + id + '/metadata', null, { responseType: 'json' });
        }
        ...
        */
        ...
        value: function getEnterpriseTemplates() {
          ...
          return this.xhr.get(this.apiBase + '/2.0/metadata_templates/enterprise', null, { responseType: 'json' });
        }
        ...
        */
        ...
        value: function getSchemaForTemplate(scope, template) {
          ...
          return this.xhr.get(this.apiBase + '/2.0/metadata_templates/' + scope + '/' + template + '/schema');
        }
      }]);
...
/***/ }
/******/ ]);
//# sourceMappingURL=boxsdk-0.1.1.js.map
