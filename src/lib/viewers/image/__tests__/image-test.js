...
describe('image.js', () => {
    ...
    it('should load an image and fire load event', (done) => {
        // Mock out fetch and return a blobed image
        sandbox.stub(util, 'get').returns(Promise.resolve(dataURLToBlob(imageUrl)));
    ...
    it('should not load an image and fire error event', (done) => {
        // Mock out fetch and return a blobed image
