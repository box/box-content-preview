...
import { CLASS_HIDDEN, TEXT_STATIC_ASSETS_VERSION, CLASS_BOX_PREVIEW_CUSTOM_FOCUS } from '../../constants';
...
class PlainTextViewer extends TextBaseViewer {
    ...
    setup() {
        ...
        this.textEl.classList.add('bp-text', 'bp-text-plain', 'hjls', CLASS_BOX_PREVIEW_CUSTOM_FOCUS, CLASS_HIDDEN);
