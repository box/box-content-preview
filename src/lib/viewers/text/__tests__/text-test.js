...
describe('text', () => {
    ...
    describe('PlainText()', () => {
        ...
        it('should set up proper text elements and initialize print', () => {
            ...
            expect(text.textEl.className).to.equal('box-preview-text box-preview-text-plain hljs box-preview-is-hidden');
    ...
    describe('destroy()', () => {
        it('should remove the download event listener if it exists', () => {
            ...
            downloadBtnEl.classList.add('box-preview-btn-download');
    ...
    describe('initPrint()', () => {
        ...
        it('should set up print checkmark and loading indicator', () => {
            ...
            expect(text.printPopup.loadingIndicator.classList.contains('box-preview-crawler'));
            expect(text.printPopup.printCheckmark instanceof HTMLElement);
            expect(text.printPopup.printCheckmark.classList.contains('box-preview-print-check'));
        });
    });
    ...
    describe('preparePrint()', () => {
        ...
        it('should enable printing via print popup after a delay', (done) => {
            ...
            expect(text.printPopup.loadingIndicator.classList.contains('box-preview-is-hidden')).to.be.true;
            expect(text.printPopup.printCheckmark.classList.contains('box-preview-is-hidden')).to.be.false;
    ...
    describe('finishLoading()', () => {
        ...
        it('should finish loading, show the text, and emit load', () => {
            ...
            expect(text.textEl.classList.contains('box-preview-is-hidden')).to.be.false;
        });
    ...
    describe('showTruncatedDownloadButton()', () => {
        ...
        it('should set up download button and bind click handler', () => {
            ...
            expect(text.textEl.querySelector('.box-preview-text-truncated')).to.not.be.null;
            const downloadBtnEl = text.textEl.querySelector('.box-preview-btn-download');
