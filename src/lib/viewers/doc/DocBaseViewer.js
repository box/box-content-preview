...
class DocBaseViewer extends BaseViewer {
    ...
    constructor(options) {
        ...
        this.handleAnnotationColorSelect = this.handleAnnotationColorSelect.bind(this);
    ...
    renderUI() {
        ...
        if (this.controls && this.options.useReactControls) {
            ...
            this.controls.render(
                <DocControls
                    annotationColor={this.annotationModule ? this.annotationModule.getColor() : null}
                    ...
                    maxScale={MAX_SCALE}
                    minScale={MIN_SCALE}
                    onAnnotationColorSelect={this.handleAnnotationColorSelect}
