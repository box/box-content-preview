...
const SCRIPTS_DOCUMENT = [`${STATIC_URI}compatibility.js`, `${STATIC_URI}pdf.min.js`, `${STATIC_URI}pdf_viewer.js`, `${STATIC_URI}pdf.worker.min.js`, 'document.js'];
...
const VIEWERS = [
    {
        ...
        SCRIPTS: [`${STATIC_URI}compatibility.js`, `${STATIC_URI}pdf.min.js`, `${STATIC_URI}pdf_viewer.js`, `${STATIC_URI}pdf.worker.min.js`, 'presentation.js'],
