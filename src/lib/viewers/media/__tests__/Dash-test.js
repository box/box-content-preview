...
describe('lib/viewers/media/Dash', () => {
    ...
    describe('showLoadingIcon()', () => {
        const loadingFunc = Dash.prototype.showLoadingIcon;

        afterEach(() => {
            Object.defineProperty(VideoBase.prototype, 'showLoadingIcon', { value: loadingFunc });
        });
        ...
        it('should show the loading indicator if active track does not equal the rep id', () => {
            ...
            Object.defineProperty(VideoBase.prototype, 'showLoadingIcon', { value: sandbox.mock() });
    ...
    describe('addEventListenersForMediaControls()', () => {
        const listenerFunc = Dash.prototype.addEventListenersForMediaControls;

        afterEach(() => {
            Object.defineProperty(VideoBase.prototype, 'addEventListenersForMediaControls', { value: listenerFunc });
        });

        it('should add event listeners to the media controls', () => {
            Object.defineProperty(VideoBase.prototype, 'addEventListenersForMediaControls', { value: sandbox.mock() });
    ...
    describe('resize()', () => {
        beforeEach(() => {
            stubs.resizeFunc = Dash.prototype.resize;
            Object.defineProperty(VideoBase.prototype, 'resize', { value: sandbox.mock() });
            dash.aspect = 1;
            dash.videoWidth = 500;
        ...
        afterEach(() => {
            Object.defineProperty(VideoBase.prototype, 'resize', { value: stubs.resizeFunc });
        });
    ...
    describe('onKeydown()', () => {
        const keydownFunc = Dash.prototype.onKeydown;

        afterEach(() => {
            Object.defineProperty(VideoBase.prototype, 'onKeydown', { value: keydownFunc });
        });
        ...
        it('should call super keydown handler for all other keys', () => {
            sandbox.stub(dash, 'toggleStats');
            Object.defineProperty(VideoBase.prototype, 'onKeydown', { value: sandbox.mock() });
