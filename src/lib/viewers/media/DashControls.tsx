            ...
            >
                ...
                <div
                    className={classNames('bp-DashControls-bar', {
                        ...
                        'bp-DashControls-bar--narrow-video': isNarrowVideo,
                    })}
                >
                    {videoAnnotationsEnabled && (
                        <div className="bp-DashControls-group bp-DashControls-group--annotations">
                            <>
                                <AnnotationsControls
                    ...
                    <div className="bp-DashControls-group bp-DashControls-group--media-controls">
