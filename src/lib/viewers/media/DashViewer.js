...
class DashViewer extends VideoBaseViewer {
    ...
    /**
     * Toggles the mask on the active guide.
     *
     * @param {boolean} isEnabled
     * @return {void}
     */
    setMaskEnabled = isEnabled => {
        this.isMaskEnabled = isEnabled;
        this.emit('guide_mask_toggled', { enabled: isEnabled });
        this.renderUI();
    };
    ...
    renderUI() {
        ...
        const isVideoPlayerV2 = this.featureEnabled('videoPlayerV2.enabled');
        const sharedProps = {
            ...
            isGuidesEnabled: isVideoPlayerV2,
            ...
            onMaskToggle: this.setMaskEnabled,
        ...
        if (isVideoPlayerV2 && this.guidesRoot) {
            this.guidesRoot.render(
                <VideoGuidesOverlay
                    guide={this.selectedGuide}
                    isMaskEnabled={this.isMaskEnabled}
                    mediaEl={this.mediaEl}
