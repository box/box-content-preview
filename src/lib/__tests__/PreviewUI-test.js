...
describe('lib/ui', () => {
    ...
    describe('cleanup()', () => {
        it('should clean up shell and remove event listeners', () => {
            ...
            const contentContainerEl = containerEl.querySelector(
                constants.SELECTOR_BOX_PREVIEW
            );
            sandbox
    ...
    describe('setup()', () => {
        it('should setup shell structure, header, and loading state', () => {
            ...
            expect(resultEl).to.equal(
                containerEl.querySelector(
                    constants.SELECTOR_BOX_PREVIEW_CONTAINER
                )
            );
            ...
            // Check loading state
            const loadingWrapperEl = resultEl.querySelector(
                constants.SELECTOR_BOX_PREVIEW_LOADING_WRAPPER
            );
            expect(loadingWrapperEl).to.contain(
                constants.SELECTOR_BOX_PREVIEW_ICON
            );
        ...
        it('should setup logo if option specifies', () => {
            ...
            // Check logo
            const defaultLogoEl = resultEl.querySelector(
                constants.SELECTOR_BOX_PREVIEW_LOGO_DEFAULT
            );
            const customLogoEl = resultEl.querySelector(
                constants.SELECTOR_BOX_PREVIEW_LOGO_CUSTOM
            );
    ...
    describe('visibility functions', () => {
        ...
        describe('showNavigation()', () => {
            it('should set up nav titles', () => {
                ...
                const leftNavEl = containerEl.querySelector(
                    constants.SELECTOR_NAVIGATION_LEFT
                );
                const rightNavEl = containerEl.querySelector(
                    constants.SELECTOR_NAVIGATION_RIGHT
                );
        ...
        describe('showPrintButton()', () => {
            it('should set up and show print button', () => {
                const buttonEl = containerEl.querySelector(
                    constants.SELECTOR_BOX_PREVIEW_BTN_PRINT
                );
                ...
                expect(buttonEl.classList.contains(constants.CLASS_HIDDEN)).to
                    .be.false;
            });
        });
        ...
        describe('showLoadingDownloadButton()', () => {
            it('should set up and show loading download button', () => {
                ...
                expect(buttonEl.title).to.equal('Download');
                expect(buttonEl.classList.contains(constants.CLASS_INVISIBLE))
                    .to.be.false;
            });
        });
        ...
        describe('showLoadingIndicator()', () => {
            it('should show loading indicator', () => {
                ...
                contentContainerEl.classList.add(
                    constants.CLASS_PREVIEW_LOADED
                );

                ui.showLoadingIndicator();

                expect(contentContainerEl).to.not.have.class(
                    constants.CLASS_PREVIEW_LOADED
                );
            });
        });
        ...
        describe('hideLoadingIndicator()', () => {
            it('should hide loading indicator', () => {
                ...
                expect(contentContainerEl).to.have.class(
                    constants.CLASS_PREVIEW_LOADED
                );
            });
        });
