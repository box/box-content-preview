...
export const X_REP_HINT_VIDEO_DASH_EXTRACTED_TEXT =
    '[extracted_text][extracted_text_en][extracted_text_fr][extracted_text_ja]';
...
export const MEDIA_STATIC_ASSETS_VERSION = '3.25.0';
