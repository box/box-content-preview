...
![NPM version](https://img.shields.io/badge/npm-v0.114.0-blue.svg)
...
https://cdn01.boxcdn.net/platform/preview/0.114.0/en-US/preview.js
https://cdn01.boxcdn.net/platform/preview/0.114.0/en-US/preview.css
...
<head>
    ...
    <script src="https://cdn01.boxcdn.net/platform/preview/0.114.0/en-US/preview.js"></script>
    <link rel="stylesheet" href="https://cdn01.boxcdn.net/platform/preview/0.114.0/en-US/preview.css" />
</head>
<body>
...
9. To rsync files after a Webpack build, create an executable file build/rsync.sh. This script will be run after every build (`yarn run build` or `yarn run watch`). A sample rsync.sh could contain:
```
sleep 1s  # Wait one second for normal webpack output to print
echo '🔄 🔄 🔄  Rsync starting for dist/ 🔄 🔄 🔄'
rsync -avz --delete --exclude=".*" dist/. YOUR_DESTINATION_DIRECTORY_HERE
```
