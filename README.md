...
[![version](https://img.shields.io/badge/version-v1.60.0-blue.svg?style=flat-square)](https://github.com/box/box-content-preview)
...
https://cdn01.boxcdn.net/platform/preview/1.60.0/en-US/preview.js  
https://cdn01.boxcdn.net/platform/preview/1.60.0/en-US/preview.css
...
1. Either fork the repo and check out the version you want to host or download the specific version as a zip:
  * Check out a specific version with `git checkout v1.60.0`
