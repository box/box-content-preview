...
[![version](https://img.shields.io/badge/version-v3.7.0-blue.svg?style=flat-square)](https://github.com/box/box-content-preview)
...
https://cdn01.boxcdn.net/platform/preview/3.7.0/en-US/preview.js
https://cdn01.boxcdn.net/platform/preview/3.7.0/en-US/preview.css
...
<html lang="en-US">
  <head>
    ...
    <script src="https://cdn01.boxcdn.net/platform/preview/3.7.0/en-US/preview.js"></script>
    <link
      rel="stylesheet"
      href="https://cdn01.boxcdn.net/platform/preview/3.7.0/en-US/preview.css"
    />
  </head>
  <body>
...
- Check out a specific version with `git checkout v3.7.0`
